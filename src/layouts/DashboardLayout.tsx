...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Tailwind v4 Theme', href: '/dashboard/design/theme', icon: 'palette' },
...
const DashboardLayout: React.FC = () => {
  ...
  const getPageTitle = () => {
    // Special case for Tailwind v4 Theme page
    if (currentPath === '/dashboard/design/theme') {
      return 'Tailwind CSS v4 Theme Demo';
    }
