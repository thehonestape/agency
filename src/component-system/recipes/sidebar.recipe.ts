...
export const sidebarRecipe: SidebarRecipe = {
  base: {
    ...
    itemLabel: 'truncate',
    itemCount:
      'ml-auto w-9 min-w-max rounded-full bg-background px-2.5 py-0.5 text-center text-xs font-medium ring-1 ring-border',
    itemInitial:
      'flex h-5 w-5 shrink-0 items-center justify-center rounded-lg border bg-background text-[0.625rem] font-medium',
    footer: 'mt-auto p-6',
  },
  variants: {
    variant: {
