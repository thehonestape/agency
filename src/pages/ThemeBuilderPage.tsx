...
const navigation = [
  ...
  {
    name: "Colors",
    href: "/theme-builder/colors",
    icon: Activity,
  },
  {
    name: "Typography",
    href: "/theme-builder/typography",
    icon: Users,
  },
  {
    name: "Components",
    href: "/theme-builder/components",
    icon: BarChart,
  },
  {
    name: "Settings",
    href: "/theme-builder/settings",
    icon: Settings,
  }
];
      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center justify-between">
            <div>
              <Heading as="h1" size="h1">Theme Builder</Heading>
              <Text className="text-muted-foreground">Create and customize your theme</Text>
            </div>
            <Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure text styles</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Preview UI components</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
