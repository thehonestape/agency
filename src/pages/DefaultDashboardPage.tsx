      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center justify-between">
            <div>
              <Heading as="h1" size="h1">Welcome</Heading>
              <Text className="text-muted-foreground">Get started with your dashboard</Text>
            </div>
            <Button>
            ...
            <Card>
              ...
              <CardContent>
                <Text className="text-sm text-muted-foreground">
                  Follow these steps to get started with your dashboard:
                </Text>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <Text className="font-medium">Welcome to your dashboard</Text>
