      ...
      <div className="flex flex-col min-h-screen bg-[var(--background)]">
        ...
        <header className="px-6 py-4 border-b border-[var(--border)] flex justify-between items-center">
          <div>
            ...
            <p className="text-[var(--muted-foreground)]">Track your projects and approvals</p>
          </div>
                            ...
                            <tr key={request.id} className="border-b border-border hover:bg-muted/50">
                              ...
                              <td className="py-3 px-4">
                                <span className="px-2 py-1 rounded-full text-xs font-medium" 
                                  style={{ 
                                    backgroundColor: 
                                      request.priority === 'High' ? 'var(--destructive-50)' : 
                                      request.priority === 'Medium' ? 'var(--warning-50)' : 
                                      'var(--info-50)',
                                    color: 
                                      request.priority === 'High' ? 'var(--destructive)' : 
                                      request.priority === 'Medium' ? 'var(--warning)' : 
                                      'var(--info)'
                                  }}>
                                  {request.priority}
                                </span>
                              ...
                              <tr key={invoice.id} className="border-b border-border hover:bg-muted/50">
                                ...
                                <td className="py-3 px-4 text-right">
                                  <span className="px-2 py-1 rounded-full text-xs font-medium" 
                                    style={{ 
                                      backgroundColor: 
                                        invoice.status === 'Paid' ? 'var(--success-50)' : 
                                        'var(--warning-50)',
                                      color: 
                                        invoice.status === 'Paid' ? 'var(--success)' : 
                                        'var(--warning)'
                                    }}>
                                    {invoice.status}
                                  </span>
