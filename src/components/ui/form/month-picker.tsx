  ...
  ({ 
    ...
    return (
      <div className="space-y-2">
        ...
        <div className={cn(monthPickerVariants({ 
          size, 
          state, 
          variant, 
          border, 
          ...
          {showIcon && (
            <Calendar className={cn(monthIconVariants({ size }))} />
          )}
          <input
            ref={ref}
            type="month"
            className={cn(monthInputVariants({ size }))}
            value={value}
...
export { MonthPicker, monthPickerVariants, monthInputVariants, monthIconVariants }; 