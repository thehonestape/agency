...
export function ThemeSwitcher({
  ...
  const variantClasses = {
    default:
      "bg-[hsl(var(--background-subtle))] hover:bg-[hsl(var(--background-muted))] text-[hsl(var(--foreground-base))]",
    outline:
      "border border-[hsl(var(--border-base))] bg-transparent hover:bg-[hsl(var(--background-subtle))] text-[hsl(var(--foreground-base))]",
    ghost:
      "bg-transparent hover:bg-[hsl(var(--background-subtle))] text-[hsl(var(--foreground-base))]",
    icon: "text-[hsl(var(--foreground-base))] hover:text-[hsl(var(--foreground-accent))]",
  };
