...
export const AlertDemo: React.FC = () => {
  return (
    <div className="mb-4 rounded-lg border border-info bg-info-subtle p-4 text-sm text-info-content">
      <div className="flex items-center">
        <svg className="mr-2 h-4 w-4 fill-current text-info" viewBox="0 0 20 20">
          <path d="M10 18a8 8 0 100-16 8 8 0 000 16zm0-2a6 6 0 110-12 6 6 0 010 12zm-1-5h2v2H9v-2zm0-6h2v4H9V5z" />
        </svg>
        <span className="font-medium text-info">Info alert!</span>
      </div>
      <div className="mt-2 pl-6 text-content-primary">
