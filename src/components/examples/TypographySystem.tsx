  ...
  return (
    <div className="typography-system space-y-8">
      <Card className="typography-card border border-border shadow-sm overflow-hidden bg-card">
        <CardHeader className="card-header border-b border-border bg-secondary px-6 py-4">
          <CardTitle className="card-title text-lg font-medium text-foreground">Headings</CardTitle>
        </CardHeader>
      ...
      <Card className="typography-card border border-border shadow-sm overflow-hidden bg-card">
        <CardHeader className="card-header border-b border-border bg-secondary px-6 py-4">
          <CardTitle className="card-title text-lg font-medium text-foreground">Text</CardTitle>
        </CardHeader>
        <CardContent className="card-content p-6">
      ...
      <Card className="typography-card border border-border shadow-sm overflow-hidden bg-card">
        <CardHeader className="card-header border-b border-border bg-secondary px-6 py-4">
          <CardTitle className="card-title text-lg font-medium text-foreground">Font Weights</CardTitle>
        </CardHeader>
        <CardContent className="card-content p-6">
      ...
      <Card className="typography-card border border-border shadow-sm overflow-hidden bg-card">
        <CardHeader className="card-header border-b border-border bg-secondary px-6 py-4">
          <CardTitle className="card-title text-lg font-medium text-foreground">Text Colors</CardTitle>
        </CardHeader>
        <CardContent className="card-content p-6">
          <div className="color-showcase space-y-4">
            <div className="color-item">
              <p className="text-lg text-foreground">Default text color</p>
              <p className="text-sm text-muted-foreground mt-1">text-foreground</p>
            </div>
            <div className="color-item">
              <p className="text-lg text-muted-foreground">Muted text color</p>
              <p className="text-sm text-muted-foreground mt-1">text-muted-foreground</p>
            </div>
            <div className="color-item">
              <p className="text-lg text-primary">Primary text color</p>
              <p className="text-sm text-muted-foreground mt-1">text-primary</p>
            </div>
            <div className="color-item">
              <p className="text-lg text-secondary">Secondary text color</p>
              <p className="text-sm text-muted-foreground mt-1">text-secondary</p>
            </div>
          </div>
        </CardContent>
      </Card>
