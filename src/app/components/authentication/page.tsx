...
export default function AuthenticationShowcase() {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <h1 className="mb-2 text-3xl font-bold">Authentication Forms</h1>
      <p className="mb-10 text-gray-600">
        Sign-in, registration, and password reset form components
      </p>

      <div className="space-y-16">
        {/* Simple Sign In */}
        <section>
          <h2 className="mb-6 border-b pb-2 text-xl font-semibold">Simple Sign In</h2>
...
/>`}
        ...
        <section>
          <h2 className="mb-6 border-b pb-2 text-xl font-semibold">Sign In with Social Options</h2>
          <div className="rounded-lg bg-white p-6 shadow">
...
/>`}
        ...
        {/* Registration Form */}
        <section>
          <h2 className="mb-6 border-b pb-2 text-xl font-semibold">Registration Form</h2>
          <div className="rounded-lg bg-white p-6 shadow">
            <RegistrationForm />
...
/>`}
        ...
        {/* Reset Password Form */}
        <section>
          <h2 className="mb-6 border-b pb-2 text-xl font-semibold">Reset Password Form</h2>
          <div className="rounded-lg bg-white p-6 shadow">
            <ResetPasswordForm />
