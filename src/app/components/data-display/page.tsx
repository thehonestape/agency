...
export default function DataDisplayIndex() {
  ...
  return (
    <div className="w-full px-4 py-8">
      <h1 className="mb-2 text-2xl font-semibold">Data Display Components</h1>
      ...
      <div className="mt-12 rounded-lg bg-blue-50 p-6">
        ...
        <p className="mt-2 text-gray-600">
          Our data display components help you present information in clear, visually appealing
          ways. Choose from different styles and options to best showcase your data.
        </p>
        <div className="mt-4">
          <Link
            href="/components/data-display/stats"
