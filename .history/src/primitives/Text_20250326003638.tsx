  ...
  ({ 
    ...
    const getSemanticStyles = () => {
      ...
      return semanticRole ? {
        ...
        ...(semanticRole !== 'heading' && semanticImportance ? importanceStyles[semanticImportance as keyof typeof importanceStyles] : {})
      } : {};
    };
    ...
    const readabilityStyles = 
      adaptToReadability && analysis && analysis.complexity !== undefined
