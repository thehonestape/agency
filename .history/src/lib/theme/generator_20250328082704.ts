...
export function generateTheme(config: ThemeConfig): Theme {
  ...
  const typography: ThemeTypography = {
    fontFamily: {
      sans: fontFamily.sans || DEFAULT_FONTS.sans,
      sansAlt: fontFamily.sansAlt || DEFAULT_FONTS.sansAlt,
      sansDisplay: fontFamily.sansDisplay || DEFAULT_FONTS.sansDisplay,
      serif: fontFamily.serif || DEFAULT_FONTS.serif,
      serifAlt: fontFamily.serifAlt || DEFAULT_FONTS.serifAlt,
      serifDisplay: fontFamily.serifDisplay || DEFAULT_FONTS.serifDisplay,
      mono: fontFamily.mono || DEFAULT_FONTS.mono,
      monoAlt: fontFamily.monoAlt || DEFAULT_FONTS.monoAlt,
      heading: fontFamily.heading || DEFAULT_FONTS.heading,
      body: fontFamily.body || DEFAULT_FONTS.body,
      code: fontFamily.code || DEFAULT_FONTS.code,
      ui: fontFamily.ui || DEFAULT_FONTS.ui,
    },
    fontSize: {
