...
export function generateTheme(config: ThemeConfig): Theme {
  ...
  const baseColors: ThemeColors = {
    ...
    'primary-foreground': isDark ? '#ffffff' : '#000000',
    secondary: secondaryColor,
    'secondary-foreground': isDark ? '#ffffff' : '#000000',
    accent: accentColor,
    'accent-foreground': isDark ? '#ffffff' : '#000000',
    
    // UI colors
    background: isDark ? '#111827' : '#ffffff',
    'background-foreground': isDark ? '#ffffff' : '#000000',
    foreground: isDark ? '#f9fafb' : '#111827',
    card: isDark ? '#1f2937' : '#ffffff',
    'card-foreground': isDark ? '#f9fafb' : '#111827',
    muted: isDark ? '#1f2937' : '#f3f4f6',
    'muted-foreground': isDark ? '#9ca3af' : '#6b7280',
    border: isDark ? '#374151' : '#e5e7eb',
    'border-foreground': isDark ? '#f9fafb' : '#111827',
    input: isDark ? '#1f2937' : '#ffffff',
    'input-foreground': isDark ? '#f9fafb' : '#111827',
    popover: isDark ? '#1f2937' : '#ffffff',
    'popover-foreground': isDark ? '#f9fafb' : '#111827',
    ring: '#3b82f6',
    ...
    'secondary-950': secondaryScale['950'],
    
    // Accent color scale
    'accent-50': accentScale['50'],
    'accent-100': accentScale['100'],
    'accent-200': accentScale['200'],
    'accent-300': accentScale['300'],
    'accent-400': accentScale['400'],
    'accent-500': accentScale['500'],
    'accent-600': accentScale['600'],
    'accent-700': accentScale['700'],
    'accent-800': accentScale['800'],
    'accent-900': accentScale['900'],
    'accent-950': accentScale['950'],
  };
