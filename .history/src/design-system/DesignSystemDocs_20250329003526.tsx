  ...
  const toggleTheme = (theme: string) => {
    ...
    if (isDark) {
      ...
      if (theme === 'blue-dark') {
        ...
        document.body.style.color = 'rgb(240 253 244)';
    ...
    // Manually update CSS variables in tailwind v4
    setTimeout(() => {
      // Force refresh
              ...
              <div className="space-y-16">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      { name: 'Blue Light', value: 'blue-light', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Blue Dark', value: 'blue-dark', style: { background: 'rgb(15 23 42)', color: 'rgb(248 250 252)' } },
                      { name: 'Green Light', value: 'green-light', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Green Dark', value: 'green-dark', style: { background: 'rgb(5 46 22)', color: 'rgb(240 253 244)' } },
                      { name: 'Zinc Light', value: 'zinc-light', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Zinc Dark', value: 'zinc-dark', style: { background: 'rgb(24 24 27)', color: 'rgb(244 244 245)' } },
                    ].map((theme) => (
                      <button
                        key={theme.value}
                        type="button"
