                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <button
                        ...
                        className={`p-4 rounded-lg border border-border hover:border-primary transition-colors ${theme.bg} ${theme.text}`}
                      >
                        <div className="text-lg font-medium">{theme.name}</div>
                        <div className="text-sm opacity-70">Click to activate</div>
                      </button>
                    ))}
                  </div>
                </div>
