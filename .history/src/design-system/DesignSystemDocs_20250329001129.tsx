            ...
            <section id="themes" className="pt-4 pb-16 scroll-mt-20">
              ...
              <div className="space-y-16">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      { name: 'Default Light', value: 'blue-light', bg: 'bg-white', text: 'text-gray-900' },
                      { name: 'Default Dark', value: 'blue-dark', bg: 'bg-gray-900', text: 'text-white' },
                      ...
                      <button
                        ...
                        className={`p-4 rounded-lg border ${currentTheme === theme.value ? 'border-primary' : 'border-border'} hover:border-primary transition-colors ${theme.bg} ${theme.text}`}
                      >
                        <div className="text-lg font-medium">{theme.name}</div>
                        <div className="text-sm opacity-70">{currentTheme === theme.value ? 'Active' : 'Click to activate'}</div>
                      </button>
                    ))}
                  </div>
                </div>
