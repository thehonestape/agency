              ...
              <div className="space-y-16">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      { name: 'Blue Light', value: 'blue-light', bg: 'bg-white', text: 'text-gray-900', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Blue Dark', value: 'blue-dark', bg: 'bg-gray-900', text: 'text-white', style: { background: 'rgb(15 23 42)', color: 'rgb(248 250 252)' } },
                      { name: 'Green Light', value: 'green-light', bg: 'bg-white', text: 'text-gray-900', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Green Dark', value: 'green-dark', bg: 'bg-green-950', text: 'text-green-50', style: { background: 'rgb(2 44 34)', color: 'rgb(240 253 250)' } },
                      { name: 'Zinc Light', value: 'zinc-light', bg: 'bg-white', text: 'text-gray-900', style: { background: 'rgb(255 255 255)', color: 'rgb(15 23 42)' } },
                      { name: 'Zinc Dark', value: 'zinc-dark', bg: 'bg-zinc-900', text: 'text-zinc-50', style: { background: 'rgb(24 24 27)', color: 'rgb(244 244 245)' } },
                    ].map((theme) => (
                      <button
                        key={theme.value}
                        type="button"
