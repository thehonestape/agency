...
export const DesignSystemDocs = () => {
  ...
  // Define sections - typography now first
  ...
  const toggleTheme = (theme: string) => {
    ...
    // Force full refresh of all styled elements
    document.body.style.display = 'none';
    
    // Force layout recalculation
    void document.documentElement.offsetHeight;
    
    // Make visible and re-enable transitions after a small delay
    setTimeout(() => {
      document.body.style.display = '';
      
      // Add a class to re-enable transitions after DOM is updated
      setTimeout(() => {
  ...
  useEffect(() => {
    ...
    if (currentDataTheme) {
      ...
      console.log(`Using existing theme: ${currentDataTheme}`);
    } else {
      // Set initial theme if none exists
      document.documentElement.dataset.theme = currentTheme;
      console.log(`Set initial theme: ${currentTheme}`);
    }
  }, []);
              ...
              <div className="space-y-16">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      { name: 'Blue Light', value: 'blue-light', bg: 'bg-white dark:bg-gray-800', text: 'text-gray-900 dark:text-white' },
                      { name: 'Blue Dark', value: 'blue-dark', bg: 'bg-gray-900', text: 'text-white' },
                      { name: 'Green Light', value: 'green-light', bg: 'bg-white dark:bg-gray-800', text: 'text-gray-900 dark:text-white' },
                      { name: 'Green Dark', value: 'green-dark', bg: 'bg-gray-900', text: 'text-white' },
                      { name: 'Zinc Light', value: 'zinc-light', bg: 'bg-white dark:bg-gray-800', text: 'text-gray-900 dark:text-white' },
