            ...
            <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <Card>
                      ...
                      <p className="text-muted-foreground">
                        This is a basic card component from our core system.
                      </p>
                    </Card>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <FeatureCard
                    title="Feature Card"
                    description="A more complex card component designed specifically for featuring content."
                    icon={<HomeIcon className="h-6 w-6" />}
                  />

                  <FeatureCard
                    title="Another Feature"
                    description="These cards can be used to highlight key features or content sections."
              ...
              <FeatureSection
                ...
                description="Larger components that compose multiple patterns together"
                features={[
                  {
                    title: "Feature 1",
