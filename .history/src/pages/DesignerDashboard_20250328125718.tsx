      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="px-6 py-4 border-b border-border flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Manage your design projects and assets</p>
          </div>
                      ...
                      <Card key={project.id} className="p-4 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                          ...
                          <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                            project.status === 'Completed' ? 'bg-success-50 text-success' : 
                            project.status === 'In Progress' ? 'bg-primary-50 text-primary' : 
                            project.status === 'Review' ? 'bg-info-50 text-info' :
        ...
        <footer className="px-6 py-4 border-t border-border">
          <div className="flex justify-between items-center">
            <Text className="text-sm text-muted-foreground">© 2023 Workhorse Co.</Text>
