...
...and so on`}
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>Our brand's custom typography uses Maison Neue for a distinctive, modern feel</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="p-6 bg-primary/5">
                  ...
                  <div className="font-sans">
                    ...
                    <div className="text-xl">abcdefghijklmnopqrstuvwxyz</div>
                    <div className="text-xl">0123456789!@#$%^&*()</div>
                  </div>
                </div>
                <div className="p-4 bg-muted/40 border-t">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <div className="font-sans font-normal mb-1">Regular</div>
                      <div className="text-xs text-muted-foreground">400 weight</div>
                    </div>
                    <div>
                      <div className="font-sans font-medium mb-1">Medium</div>
                      <div className="text-xs text-muted-foreground">500 weight</div>
                    </div>
                    <div>
                      <div className="font-sans font-bold mb-1">Bold</div>
                      <div className="text-xs text-muted-foreground">700 weight</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="border rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-muted/40 border-t">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="font-mono font-normal mb-1">Regular</div>
                      <div className="text-xs text-muted-foreground">400 weight</div>
                    </div>
                    <div>
                      <div className="font-mono font-bold mb-1">Bold</div>
                      <div className="text-xs text-muted-foreground">700 weight</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-8 border rounded-lg overflow-hidden">
              <div className="p-6 bg-primary/5">
                <h3 className="font-medium mb-3">Extended Font Weights</h3>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-sm uppercase tracking-wider text-muted-foreground mb-3">Sans-Serif Weights</h4>
                      <div className="space-y-3">
                        <div>
                          <div className="font-sans font-light text-xl">Light (300)</div>
                          <div className="font-sans font-light text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-sans font-normal text-xl">Regular (400)</div>
                          <div className="font-sans font-normal text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-sans font-medium text-xl">Medium (500)</div>
                          <div className="font-sans font-medium text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-sans font-semibold text-xl">Demi (600)</div>
                          <div className="font-sans font-semibold text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-sans font-bold text-xl">Bold (700)</div>
                          <div className="font-sans font-bold text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                      </div>
                    </div>
                    <div>
                      <h4 className="text-sm uppercase tracking-wider text-muted-foreground mb-3">Italic Styles</h4>
                      <div className="space-y-3">
                        <div>
                          <div className="font-sans font-normal italic text-xl">Regular Italic</div>
                          <div className="font-sans font-normal italic text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-sans font-medium italic text-xl">Medium Italic</div>
                          <div className="font-sans font-medium italic text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                        <div>
                          <div className="font-mono font-normal italic text-xl">Mono Italic</div>
                          <div className="font-mono font-normal italic text-sm">The quick brown fox jumps over the lazy dog</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-8 bg-muted/30 p-6 rounded-lg border">
              <h3 className="text-xl font-semibold mb-4">Font Implementation</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Maison Neue is implemented through CSS variables in our design system:
              </p>
              <pre className="bg-muted p-3 rounded-md text-xs mb-4">
{`:root {
  --font-maison-neue: 'Maison Neue', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
  --font-maison-neue-mono: 'Maison Neue Mono', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;
}`}
              </pre>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="text-base font-medium mb-2">Usage in Tailwind</h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">+</div>
                      <span><code className="text-xs bg-muted/60 px-1 py-0.5 rounded">font-sans</code> applies Maison Neue</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">+</div>
                      <span><code className="text-xs bg-muted/60 px-1 py-0.5 rounded">font-mono</code> applies Maison Neue Mono</span>
                    </li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-base font-medium mb-2">Weight Classes</h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">+</div>
                      <span><code className="text-xs bg-muted/60 px-1 py-0.5 rounded">font-normal</code> - Regular (400)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">+</div>
                      <span><code className="text-xs bg-muted/60 px-1 py-0.5 rounded">font-medium</code> - Medium (500)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">+</div>
                      <span><code className="text-xs bg-muted/60 px-1 py-0.5 rounded">font-bold</code> - Bold (700)</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <Alert className="mt-4" variant="success">
                ...
                <AlertDescription className="mt-2 text-sm">
                  The design system is now using the actual Maison Neue font files. These commercial fonts are properly loaded from the <code className="text-xs bg-muted/60 px-1 py-0.5 rounded">src/fonts/</code> directory, ensuring consistent typography across all components and layouts.
                </AlertDescription>
              </Alert>
            </div>
          </CardContent>
