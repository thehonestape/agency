            ...
            <section id="resources-guides" className="scroll-mt-16 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <div>
                      <Text size="sm" weight="medium" className="mb-2">Introduction to the Design System</Text>
                      <Text className="mb-4">
                        Our design system provides a comprehensive set of guidelines, components, and patterns 
                        to create consistent and cohesive user experiences across all our products.
                      </Text>
                      <div className="rounded-md bg-muted/20 p-4">
                        <ol className="list-decimal pl-5 space-y-2">
                          <li>
                            <Text size="sm" weight="medium">Get access to our resources</Text>
                            <Text size="sm">Contact your design team lead for access to design files and code repositories.</Text>
                          </li>
                          <li>
                            <Text size="sm" weight="medium">Set up your development environment</Text>
                            <Text size="sm">Follow our setup guide to configure your environment for working with the design system.</Text>
                          </li>
                          <li>
                            <Text size="sm" weight="medium">Explore components and guidelines</Text>
                            <Text size="sm">Familiarize yourself with our system through documentation and examples.</Text>
                          </li>
                          <li>
                            <Text size="sm" weight="medium">Join the community</Text>
                            <Text size="sm">Connect with other team members through our Slack channel for questions and feedback.</Text>
                          </li>
                        </ol>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex gap-2 p-3 rounded-md border hover:border-primary hover:bg-muted/10 cursor-pointer">
                          ...
                          <div>
                            <Text size="sm" weight="medium">Designer Onboarding</Text>
                            <Text size="xs" className="text-muted-foreground">Guide for designers joining the system</Text>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2 p-3 rounded-md border hover:border-primary hover:bg-muted/10 cursor-pointer">
                          ...
                          <div>
                            <Text size="sm" weight="medium">Developer Onboarding</Text>
                            <Text size="xs" className="text-muted-foreground">Guide for developers implementing the system</Text>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2 p-3 rounded-md border hover:border-primary hover:bg-muted/10 cursor-pointer">
                          ...
                          <div>
                            <Text size="sm" weight="medium">Component Documentation</Text>
                            <Text size="xs" className="text-muted-foreground">Detailed specifications for all components</Text>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2 p-3 rounded-md border hover:border-primary hover:bg-muted/10 cursor-pointer">
                          ...
                          <div>
                            <Text size="sm" weight="medium">FAQs</Text>
                            <Text size="xs" className="text-muted-foreground">Common questions and their answers</Text>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="p-4 rounded-md bg-muted/10 border space-y-2">
                          ...
                          <Text size="sm" weight="medium">Consistency</Text>
                          <Text size="sm">Create predictable experiences through consistent patterns and interactions.</Text>
                        </div>
                        ...
                        <div className="p-4 rounded-md bg-muted/10 border space-y-2">
                          ...
                          <Text size="sm" weight="medium">Efficiency</Text>
                          <Text size="sm">Optimize for speed, performance, and user productivity in all interactions.</Text>
                        </div>
                        ...
                        <div className="p-4 rounded-md bg-muted/10 border space-y-2">
                          ...
                          <Text size="sm" weight="medium">Accessibility</Text>
                          <Text size="sm">Design for everyone by prioritizing universal access and usability.</Text>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="p-4 rounded-md border">
                        <ul className="space-y-2">
                          <li className="flex items-center gap-2">
                            ...
                            <Text size="sm">Use the correct component variants and props</Text>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-5 w-5 rounded-full border border-primary flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-primary">
                            ...
                            <Text size="sm">Follow spacing and layout guidelines</Text>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-5 w-5 rounded-full border border-primary flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-primary">
                            ...
                            <Text size="sm">Maintain responsive behavior across breakpoints</Text>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-5 w-5 rounded-full border border-primary flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-primary">
                            ...
                            <Text size="sm">Ensure all interactive elements are accessible</Text>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-5 w-5 rounded-full border border-primary flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-primary">
                            ...
                            <Text size="sm">Test implementation in different environments</Text>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-muted/20 rounded-md space-y-2">
                    <Text size="sm" weight="medium">Need Help?</Text>
                    <Text size="sm">
