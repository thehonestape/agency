...
const HomePage = () => {
  return (
    <Box className="min-h-screen bg-background">
      <Box as="header" className="sticky top-0 z-40 border-b bg-background">
        <Container>
          <Flex className="h-16 items-center justify-between">
            <Flex className="items-center gap-2">
              <Heading as="h1" className="text-xl font-bold">Semantic UI</Heading>
            </Flex>
            <Flex className="items-center gap-4">
              <Box as="nav" className="hidden md:flex items-center space-x-4">
      ...
      <Box as="main" className="py-8">
        <Container>
          <Stack className="gap-4 text-center mb-12">
            <Heading as="h1" className="text-4xl font-bold tracking-tight">Semantic Component System</Heading>
