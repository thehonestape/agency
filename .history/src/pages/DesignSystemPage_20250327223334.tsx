    ...
    <div className="space-y-10">
      <Card>
        ...
        <CardContent className="space-y-6">
          <div>
            <Text className="font-medium mb-2">Default Input</Text>
          ...
          <div>
            <Text className="font-medium mb-2">Disabled Input</Text>
            <div className="max-w-sm">
              <input
                type="text"
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <div>
            <Text className="font-medium mb-2">Textarea</Text>
            <div className="max-w-sm">
              <textarea
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <div className="inline-flex h-[24px] w-[44px] shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent bg-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50">
  ...
  return (
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-64 flex-shrink-0 md:sticky md:top-20 md:h-[calc(100vh-80px)]">
          <Card>
            <CardContent className="p-4">
              <Text className="font-semibold mb-4 text-lg">Design System</Text>
