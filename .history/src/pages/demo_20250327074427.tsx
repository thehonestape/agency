      ...
      >
        <div className="space-y-12">
          ...
          <div className="space-y-2">
            <Heading as="h1" size="h1">Design System</Heading>
            <Text className="text-muted-foreground">A comprehensive showcase of our design tokens, components, and patterns.</Text>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-2">
                  <FiType className="h-5 w-5 text-muted-foreground" />
                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Our complete heading hierarchy from h1 to h6</CardDescription>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Text styles for body content and paragraphs</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="space-y-2">
            ...
            {/* Right Column - Colors & Layout */}
            <div className="space-y-8">
              {/* Color System */}
              <section className="space-y-4">
                <div className="flex items-center gap-2">
                  <FiDroplet className="h-5 w-5 text-muted-foreground" />
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-2">
                  <FiLayout className="h-5 w-5 text-muted-foreground" />
                  <Heading as="h2" size="h2">Layout Components</Heading>
                </div>
