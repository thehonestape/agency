  ...
  return (
    <div className="max-w-none pl-0">
      ...
      <div className="mb-8 p-4 bg-muted/20 rounded-lg">
        <Heading variant="h3" className="mb-4">Components</Heading>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          <a href="#foundations" className="text-primary hover:underline">Foundations</a>
          <a href="#typography" className="text-primary hover:underline">Typography</a>
          <a href="#color" className="text-primary hover:underline">Color</a>
          <a href="#layout" className="text-primary hover:underline">Layout</a>
          <a href="#buttons" className="text-primary hover:underline">Buttons</a>
          <a href="#inputs" className="text-primary hover:underline">Inputs</a>
          <a href="#navigation" className="text-primary hover:underline">Navigation</a>
          <a href="#feedback" className="text-primary hover:underline">Feedback</a>
          <a href="#data-display" className="text-primary hover:underline">Data Display</a>
        </div>
      </div>
