          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  <Heading as="h3" size="h3" className="mb-2">Headings</Heading>
                ...
                <div>
                  <Heading as="h3" size="h3" className="mb-2">Body Text</Heading>
                  <div className="space-y-2">
                    <Text size="lg">Large body text for important content</Text>
                    <Text>Regular body text for normal content</Text>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Text in Context</CardTitle>
                  <CardDescription>How typography looks in a card component</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <Text>This is a sample of how different text styles work together in a card component. The heading above uses the h3 style, while this paragraph uses the regular body text style.</Text>
                  <Text size="sm" className="text-muted-foreground">This is a smaller text with muted color, often used for secondary information or footnotes.</Text>
                </CardContent>
              </Card>
            </div>
          </section>
