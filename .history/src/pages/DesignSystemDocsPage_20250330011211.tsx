        ...
        <ComponentPreview title="Sheet Examples">
          <div className="flex flex-wrap gap-4">
            <div className="w-full md:w-auto">
              <h3 className="text-lg font-semibold mb-2">Side Sheet</h3>
              <p className="text-muted-foreground mb-4">
                Customizable side panel that slides in from the edge of the screen.
              </p>
              <Card className="p-4">
                <code className="text-sm">
                  {`
  ...
  <SheetContent>
    ...
    <div className="py-4">
      ...
      >
        ...
        <ComponentPreview title="Combobox Integration">
          <div className="w-full">
            <h3 className="text-lg font-semibold mb-2">Combobox</h3>
            <p className="text-muted-foreground mb-4">
              A searchable select component with typeahead functionality.
            </p>
            <Card className="p-4">
              <code className="text-sm">
                {`
  ...
  <AvatarFallback>JD</AvatarFallback>
      ...
      >
        ...
        <ComponentPreview title="Scroll Area">
          <div className="w-full p-4 border rounded-lg max-w-md mx-auto">
            <h4 className="font-medium mb-2">Scroll Area Example</h4>
            <div className="h-[200px] w-full overflow-auto rounded-md border p-4">
              <div className="space-y-4">
                <p>
                  This is a scroll area component demonstration. It creates a scrollable container with a consistent scrollbar appearance across different browsers.
                </p>
                <p>
          ...
          <div className="mt-4 text-sm text-muted-foreground">
            Scroll areas provide a consistent scrolling experience across different browsers and platforms.
          </div>
        </ComponentPreview>
      </Section>
