...
import { BrandSidebarWithHeader } from '@/components/ui/shell/sidebar/BrandSidebarWithHeader';
...
const mainContent = (
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <div>
        <Heading variant="h1" size="4xl">Semantic Component System</Heading>
        <Text className="text-muted-foreground">A showcase of our semantic design system</Text>
      </div>
      <Button>
...
export default function SemanticSystemPage() {
  return (
