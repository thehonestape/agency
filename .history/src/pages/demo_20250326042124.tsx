        ...
        <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
          ...
          <div className="fixed inset-0 flex">
            <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-background/95 backdrop-blur-sm px-6 pb-2 border-r border-border">
              ...
              <section id="application-shells" className="space-y-6">
                ...
                <div className="rounded-lg border border-border bg-card p-6">
                  ...
                  <div className="rounded-lg border border-border bg-muted p-4">
                    <div className="h-32 flex items-center justify-center bg-background text-muted-foreground">
                      Shell Preview
                    </div>
                  </div>
                </div>
