import React, { useState, useRef, useEffect, ReactNode, DragEvent, lazy, Suspense } from 'react';
...
// For components not in the UI object
...
// Destructure UI components for clarity and potentially better tree-shaking
const {
  Card,
  CardHeader,
  CardTitle,
