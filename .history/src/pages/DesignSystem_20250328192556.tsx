        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-8 py-8 space-y-16">
            ...
            <section id="resources-guides" className="scroll-mt-16 space-y-6">
              ...
              <Text className="text-lg">
                Our guides provide in-depth explanations and best practices for various design and development topics.
              </Text>
              
              <Card>
                <CardHeader>
                  <CardTitle>Design Principles</CardTitle>
                  <CardDescription>Key principles to guide your design decisions</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Consistency</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Consistency is key to creating a cohesive user experience. We strive to maintain a consistent look and feel across all our products.</Text>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="p-4 border rounded-md">
                        <Text>Accessibility is a fundamental aspect of design. We aim to create interfaces that are usable by everyone, including those with disabilities.</Text>
                      </div>
                    </div>
                    
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Responsive Design</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Responsive design ensures that your website looks great on any device. We use fluid layouts and media queries to achieve this.</Text>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Understanding color psychology and its impact on user experience</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Color Palettes</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Choosing the right color palette is crucial for creating a visually appealing and harmonious design. We use a thoughtful color system that communicates our brand and enhances usability.</Text>
                      </div>
                    </div>
                    
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Color Psychology</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Understanding how colors affect user emotions and behaviors can greatly enhance the effectiveness of your design. We explore color psychology in depth.</Text>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Choosing the right typeface and hierarchy for your content</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Typefaces</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Choosing the right typeface is essential for creating a readable and visually appealing design. We provide a range of typefaces that cover various styles and purposes.</Text>
                      </div>
                    </div>
                    
                    <div>
                      <Text size="sm" weight="medium" className="mb-3">Typographic Hierarchy</Text>
                      <div className="p-4 border rounded-md">
                        <Text>Typographic hierarchy is crucial for creating a clear and organized information structure. We use a consistent typographic scale to establish hierarchy and emphasis.</Text>
                      </div>
                    </div>
                  </div>
                </CardContent>
