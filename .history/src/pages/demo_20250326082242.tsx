...
const typographyExamples = [
  { level: 1, label: 'Heading 1', description: 'Bold / Leading-tight' },
  { level: 2, label: 'Heading 2', description: 'Semibold / Leading-tight' },
  { level: 3, label: 'Heading 3', description: 'Medium / Leading-tight' },
  { level: 4, label: 'Heading 4', description: 'Regular / Leading-normal' },
  { level: 5, label: 'Heading 5', description: 'Regular / Leading-normal' },
  { level: 6, label: 'Heading 6', description: 'Regular / Leading-normal' }
]
