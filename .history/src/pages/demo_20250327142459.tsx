...
const mainContent = (
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <div>
        <Heading as="h1" size="4xl">Dashboard</Heading>
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <Heading as="h2" size="3xl">Shell Layouts</Heading>
          </div>
            ...
            <CardContent>
              <div className="h-[400px] overflow-hidden rounded-lg border">
                <BrandSidebarWithHeader
                  ...
                  sections={sections}
                  brandName="Acme Inc."
                  brandLogo={<div className="h-8 w-8 rounded bg-primary" />}
                >
                  <div className="p-6">
                    <Heading as="h3" size="2xl">Main Content</Heading>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <Heading as="h2" size="3xl">Component Examples</Heading>
          </div>
