      ...
      >
        ...
        <ComponentPreview title="Typography Components">
          <div className="grid gap-6">
            <UI.Typography.Heading>Heading Component</UI.Typography.Heading>
            <UI.Typography.SubHeading level={1}>SubHeading Level 1</UI.Typography.SubHeading>
            <UI.Typography.SubHeading level={2}>SubHeading Level 2</UI.Typography.SubHeading>
            <UI.Typography.Text>Standard Text Component for paragraphs and content</UI.Typography.Text>
            <UI.Typography.Text variant="muted">Muted Text Variant</UI.Typography.Text>
            <div className="flex gap-4 items-center">
              <UI.Typography.Code>console.log('Code Component')</UI.Typography.Code>
              <UI.Typography.Kbd>Ctrl</UI.Typography.Kbd>+<UI.Typography.Kbd>C</UI.Typography.Kbd>
            </div>
          </div>
        </ComponentPreview>
        ...
        <ComponentPreview title="Dialog Components">
          <div className="grid gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <UI.Dropdown>
                <UI.DropdownButton variant="outline">
                  Open Dropdown
                </UI.DropdownButton>
                <UI.DropdownMenu>
                  <UI.DropdownHeader>
                    <UI.DropdownHeading>Account</UI.DropdownHeading>
                    <UI.DropdownDescription>Manage your account settings</UI.DropdownDescription>
                  </UI.DropdownHeader>
                  <UI.DropdownDivider />
                  <UI.DropdownItem>Profile</UI.DropdownItem>
                  <UI.DropdownItem>Settings</UI.DropdownItem>
                  <UI.DropdownItem>Logout</UI.DropdownItem>
                </UI.DropdownMenu>
              </UI.Dropdown>
            </div>
          </div>
        ...
        <ComponentPreview title="Advanced Components">
          <div className="grid gap-8">
            <UI.Card>
              <UI.CardHeader>
                <UI.CardTitle>Card Component</UI.CardTitle>
              </UI.CardHeader>
              <UI.CardContent>
            ...
            <UI.ColorScale steps={5} startColor="rgb(14, 116, 144)" endColor="rgb(186, 230, 253)" className="h-8 rounded-md overflow-hidden" />
          </div>
        </ComponentPreview>
