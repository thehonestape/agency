      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center justify-between">
            <div>
              <Heading as="h1" size="h1">Component Library</Heading>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="h2">Form Patterns</Heading>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="h2">List Patterns</Heading>
            <Button variant="outline" size="sm">
              View All Lists
            </Button>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="h2">Dashboard Patterns</Heading>
            <Button variant="outline" size="sm">
              View All Dashboards
            </Button>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="h2">UI Components</Heading>
            <Button variant="outline" size="sm">
              View All Components
            </Button>
          </div>
