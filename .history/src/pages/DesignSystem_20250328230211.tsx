...
import { Heading, Text, SubHeading } from '@/components/ui/typography';
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-8 py-8 space-y-16">
            ...
            <section className="mb-12">
              <h1 className="text-4xl text-fluid-4xl font-bold mb-4">Workhorse Design</h1>
              <h2 className="text-2xl text-fluid-2xl font-semibold mb-6">Design System</h2>
              <p className="text-lg text-fluid-lg text-muted-foreground">
            ...
            <section id="foundations-typography" className="scroll-mt-16 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Complete set of heading components with proper scaling</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>SubHeading Component</CardTitle>
                  <CardDescription>Convenient subheadings with preset styling for secondary content</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      <SubHeading level={1} className="mb-2">Level 1 SubHeading</SubHeading>
                      <Text className="text-sm text-muted-foreground">Primary subheading for section descriptions and introductory text</Text>
                    </div>
                    <div>
                      <SubHeading level={2} className="mb-2">Level 2 SubHeading</SubHeading>
                      <Text className="text-sm text-muted-foreground">Secondary subheading for additional context and supporting information</Text>
                    </div>
                    <div>
                      <SubHeading level={3} className="mb-2">Level 3 SubHeading</SubHeading>
                      <Text className="text-sm text-muted-foreground">Tertiary subheading for details and supplementary content</Text>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      <Heading variant="h2" size="5xl" className="mb-2">Display Heading (5xl)</Heading>
                      <Text className="text-sm text-muted-foreground">Large impactful text for hero sections and major features</Text>
                    </div>
                    <div>
                      <Heading variant="h3" size="4xl" className="mb-2">Oversized Heading (4xl)</Heading>
                      <Text className="text-sm text-muted-foreground">Using h3 with 4xl size for feature sections</Text>
                    </div>
                    <div>
                      <Heading variant="h2" size="2xl" className="mb-2">Understated Heading</Heading>
                      <Text className="text-sm text-muted-foreground">Using h2 with 2xl size for more subtle section headers</Text>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-4 bg-muted/20 rounded-md">
                      <Text size="lg">This is large text used for introductory paragraphs, lead-ins, or when you want to emphasize a specific paragraph.</Text>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-4 bg-muted/20 rounded-md">
                      <Text size="sm">This smaller text is used for secondary information, metadata, captions, and footer content.</Text>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <section id="foundations-colors" className="scroll-mt-16 space-y-6">
              ...
              <div className="text-lg">
                Our palette reflects our brand personality and guides the visual tone.
              </div>
            ...
            <section id="components-buttons" className="scroll-mt-16 space-y-6">
              ...
              <div className="text-lg">
                Interactive controls that enable users to trigger actions and navigate.
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-2 border-t">
                      <div className="text-sm text-muted-foreground">
                        Choose appropriate variants based on action importance: <span className="font-medium">Default</span> for primary actions, <span className="font-medium">Secondary</span> for secondary actions, <span className="font-medium">Outline</span> for tertiary actions, <span className="font-medium">Ghost</span> for subtle actions in dense UIs, <span className="font-medium">Link</span> for navigation-style actions, and <span className="font-medium">Destructive</span> for dangerous operations.
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent className="space-y-8">
                  <div className="space-y-6">
                    ...
                    <div className="pt-2 border-t">
                      <div className="text-sm text-muted-foreground">
                        Choose appropriate sizes based on context: <span className="font-medium">Small</span> for compact UIs, <span className="font-medium">Default</span> for most standard cases, <span className="font-medium">Large</span> for prominent actions, and <span className="font-medium">Icon</span> for square buttons with only an icon.
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <section id="components-forms" className="scroll-mt-16 space-y-6">
              ...
              <div className="text-lg">
                Input components for collecting and processing user data.
              </div>
            ...
            <section id="components-cards" className="scroll-mt-16 space-y-6">
              ...
              <div className="text-lg">
                Contained components for organizing and displaying related content.
              </div>
            ...
            <section id="components-feedback" className="scroll-mt-16 space-y-6">
              ...
              <div className="text-lg">
                Components that provide information about system status and operations.
              </div>
            ...
            <section id="resources-guides" className="scroll-mt-16 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="font-medium text-sm leading-snug">Quick Links</div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <div>
                      <div className="font-medium text-sm leading-snug mb-2">Design Principles</div>
                    ...
                    <div>
                      <div className="font-medium text-sm leading-snug mb-2">Implementation Checklist</div>
