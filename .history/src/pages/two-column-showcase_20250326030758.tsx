...
export function TwoColumnShowcase() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className={`relative inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
      ...
      <div className="fixed inset-y-0 left-0 z-40 hidden w-72 flex-col border-r border-gray-200 bg-white lg:flex">
      ...
      {/* Right sidebar */}
      <aside className="fixed inset-y-0 right-0 z-30 w-96 border-l border-gray-200 bg-white px-4 py-6 overflow-y-auto sm:px-6 lg:px-8 hidden xl:block">
