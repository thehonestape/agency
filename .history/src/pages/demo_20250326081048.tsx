  ...
  return (
    <>
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-40 flex h-16 items-center gap-x-4 border-b border-border bg-primary px-6">
          <button
            type="button"
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex flex-1 items-center">
              <h1 className="text-2xl font-semibold text-primary-foreground">Components</h1>
            </div>
