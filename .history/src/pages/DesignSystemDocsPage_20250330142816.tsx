              ...
              <CardContent>
                <div className="prose dark:prose-invert">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Website</div>
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Mobile App</div>
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Print Materials</div>
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Social Media</div>
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Presentations</div>
                    <div className="bg-muted/30 px-3 py-1 rounded-full text-sm font-medium cursor-grab">Email</div>
                  </div>
                      ...
                      <div className="space-y-6">
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2 mt-2">
                            <Badge variant="outline" className="bg-background">Marketing</Badge>
                            <Badge variant="outline" className="bg-background">Editorial</Badge>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2 mt-2">
                            <Badge variant="outline" className="bg-background">Product</Badge>
                            <Badge variant="outline" className="bg-background">Digital</Badge>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2 mt-2">
                            <Badge variant="outline" className="bg-background">Campaigns</Badge>
                            <Badge variant="outline" className="bg-background">Presentations</Badge>
                          </div>
                        </div>
                      </div>
                    </div>
