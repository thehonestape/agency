...
const themeToCssVariables = (theme: Theme): string => {
  const variables = [
    `:root {`,
    `  --color-primary: ${theme.tokens?.colors?.primary || '#000'};`,
    `  --color-secondary: ${theme.tokens?.colors?.secondary || '#6c757d'};`,
    `  --color-accent: ${theme.tokens?.colors?.accent || '#ff7b00'};`,
    `  --color-background: ${theme.tokens?.colors?.background || '#fff'};`,
    `  --color-text: ${theme.tokens?.colors?.foreground || '#000'};`,
    `  --color-muted: ${theme.tokens?.colors?.muted || '#f5f5f5'};`,
    `  --color-border: ${theme.tokens?.colors?.border || '#e2e8f0'};`,
    `  --font-heading: ${theme.tokens?.typography?.fontFamily?.sans || 'sans-serif'};`,
    `  --font-body: ${theme.tokens?.typography?.fontFamily?.sans || 'sans-serif'};`,
    `  --radius-sm: ${theme.tokens?.borderRadius?.sm || '0.25rem'};`,
    `  --radius-md: ${theme.tokens?.borderRadius?.DEFAULT || '0.5rem'};`,
    `  --radius-lg: ${theme.tokens?.borderRadius?.lg || '1rem'};`,
    `  --spacing-xxs: ${theme.tokens?.spacing?.['0.5'] || '0.125rem'};`,
    `  --spacing-xs: ${theme.tokens?.spacing?.['1'] || '0.25rem'};`,
    `  --spacing-sm: ${theme.tokens?.spacing?.['2'] || '0.5rem'};`,
    `  --spacing-md: ${theme.tokens?.spacing?.['4'] || '1rem'};`,
    `  --spacing-lg: ${theme.tokens?.spacing?.['6'] || '1.5rem'};`,
    `  --spacing-xl: ${theme.tokens?.spacing?.['8'] || '2rem'};`,
    `  --spacing-xxl: ${theme.tokens?.spacing?.['12'] || '3rem'};`,
    `}`,
  ];
      ...
      <div style={{ padding: '1.5rem' }}>
        ...
        <div 
          ...
          style={{ 
            ...
            backgroundColor: previewTheme.tokens?.colors?.background,
            color: previewTheme.tokens?.colors?.foreground,
            position: 'relative',
        ...
        >
          <h1 style={{ 
            fontSize: '2.5rem', 
            marginBottom: '0.5rem',
            fontFamily: previewTheme.tokens?.typography?.fontFamily?.sans,
            fontWeight: 700,
            color: previewTheme.tokens?.colors?.primary
          }}>
            Heading Level 1
          </h1>
          <h2 style={{ 
          ...
          <div style={{ 
            padding: '1rem', 
            backgroundColor: previewTheme.tokens?.colors?.muted,
            borderRadius: 'var(--radius-md)',
            fontSize: '0.875rem',
            color: previewTheme.tokens?.colors?.foreground
          }}>
