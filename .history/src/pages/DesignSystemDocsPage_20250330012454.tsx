...
const DesignSystemDocsPage: React.FC = () => {
  ...
  const sections = [
    ...
    { id: "dropdown", title: "Dropdown & Popover", icon: CommandLineIcon },
    ...
    { id: "accordion", title: "Accordion", icon: ViewColumnsIcon },
...
<Avatar>
  ...
  <AvatarFallback>JD</AvatarFallback>
      ...
      >
        <ComponentPreview title="Accordion Example">
        ...
        <ComponentPreview title="Multiple Accordions">
