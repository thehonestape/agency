        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5">
            <Card className="h-full">
              ...
              <CardContent>
                <div className="prose dark:prose-invert">
                  <p>
                    Our typography system creates a visual foundation that balances aesthetics with functional clarity. 
                    We carefully select typefaces that support our design principles:
                  </p>
                  <ul className="space-y-4 mt-4">
                    <li className="flex gap-3">
                      <div className="mt-1 h-5 w-5 flex items-center justify-center rounded-full bg-primary text-primary-foreground text-xs">1</div>
                      <div>
                        <strong className="block text-base">Product Typography</strong>
                        <span className="text-sm text-muted-foreground">Clean, functional sans-serif for interface elements and content</span>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <div className="mt-1 h-5 w-5 flex items-center justify-center rounded-full bg-primary text-primary-foreground text-xs">2</div>
                      <div>
                        <strong className="block text-base">Marketing Typography</strong>
                        <span className="text-sm text-muted-foreground">Distinctive, expressive typefaces that convey our brand personality</span>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <div className="mt-1 h-5 w-5 flex items-center justify-center rounded-full bg-primary text-primary-foreground text-xs">3</div>
                      <div>
                        <strong className="block text-base">Editorial Typography</strong>
                        <span className="text-sm text-muted-foreground">Refined serifs that enhance readability for long-form content</span>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <div className="mt-1 h-5 w-5 flex items-center justify-center rounded-full bg-primary text-primary-foreground text-xs">4</div>
                      <div>
                        <strong className="block text-base">Technical Typography</strong>
                        <span className="text-sm text-muted-foreground">Monospace fonts for code blocks and technical documentation</span>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="md:col-span-7">
            <Card>
              ...
              <CardContent>
                <div className="mb-6">
                  <p>Our design system employs multiple typography scales that work together:</p>
                </div>
                ...
                <Tabs defaultValue="semantic">
                  <TabsList className="mb-4">
                    ...
                    <TabsTrigger value="headline">Content Scale</TabsTrigger>
                  </TabsList>
                  
                  <TabsContent value="semantic" className="space-y-4">
                    <div className="p-4 bg-muted/30 rounded-md mb-4">
                      <p className="text-sm text-muted-foreground">
                        Our semantic scale is contextual and purpose-driven, focusing on the role rather than the specific HTML element.
                      </p>
                    </div>
                    <div className="space-y-5">
                      <div className="border-b pb-3">
                        <div className="text-4xl font-bold">Display</div>
                        <p className="text-sm text-muted-foreground mt-1">For hero sections and major headlines</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-3xl font-semibold">Title</div>
                        <p className="text-sm text-muted-foreground mt-1">For page headers and major section dividers</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-2xl font-semibold">Heading</div>
                        <p className="text-sm text-muted-foreground mt-1">For content section headers</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-xl font-medium">Subheading</div>
                        <p className="text-sm text-muted-foreground mt-1">For subsection headers, card titles</p>
                      </div>
                      <div className="border-b pb-3">
                  ...
                  <TabsContent value="html" className="space-y-4">
                    <div className="p-4 bg-muted/30 rounded-md mb-4">
                      <p className="text-sm text-muted-foreground">
                        HTML elements provide semantic meaning and default styling that forms the foundation of our typography.
                      </p>
                    </div>
                    <div className="space-y-5">
                  ...
                  <TabsContent value="headline" className="space-y-4">
                    <div className="p-4 bg-muted/30 rounded-md mb-4">
                      <p className="text-sm text-muted-foreground">
                        The content scale creates visual distinction for marketing materials, editorial content, and branded experiences.
                      </p>
                    </div>
                    <div className="space-y-5">
                      <div className="border-b pb-3">
                        <div className="text-5xl font-bold">Headline XL</div>
                        <p className="text-sm text-muted-foreground mt-1">For landing page heroes and major statements</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-4xl font-bold">Headline L</div>
                        <p className="text-sm text-muted-foreground mt-1">For article headlines and feature introductions</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-3xl font-semibold">Headline M</div>
                        <p className="text-sm text-muted-foreground mt-1">For section headers and promotional content</p>
                      </div>
                      <div className="border-b pb-3">
                      ...
                      <div className="border-b pb-3">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">Supportive text under headlines</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-lg font-medium">Subheadline M</div>
                        <p className="text-sm text-muted-foreground mt-1">Secondary content headers</p>
                      </div>
                      <div className="border-b pb-3">
                        <div className="text-base font-medium">Subheadline S</div>
                        <p className="text-sm text-muted-foreground mt-1">Tertiary headers and callouts</p>
                      </div>
                    </div>
                  </TabsContent>
                </Tabs>
            ...
            <div className="mt-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    <span>Dynamic Type Controls</span>
                    <Button variant="ghost" size="sm" className="opacity-0">
                      <PencilIcon className="h-4 w-4" />
                    </Button>
                  </CardTitle>
                ...
                <CardContent>
                    ...
                    <div className="flex flex-col gap-y-4">
                      <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Input 
                            ...
                            className="w-24"
                          />
                          <div className="text-sm text-muted-foreground">Adjusts the root font size</div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-sm text-muted-foreground">Controls the progression between sizes</div>
                        </div>
                      </div>
                  ...
                  <div className="mt-4 text-sm text-muted-foreground">
                    <p>Adjust the base size and scale ratio to see how changes propagate through the entire type system. This demonstrates how our typography is built on mathematical relationships that maintain proportion across all elements.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
