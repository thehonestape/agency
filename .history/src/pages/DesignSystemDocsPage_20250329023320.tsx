  ...
  return (
    <div className="bg-background flex h-screen overflow-hidden">
      ...
      <div
        ...
        } fixed inset-y-0 left-0 z-40 w-64 border-r border-border bg-background transition-transform duration-300 ease-in-out md:hidden`}
      >
        <div className="flex h-full flex-col">
          <div className="border-border flex h-16 flex-shrink-0 items-center justify-between border-b px-4">
            <Link to="/" className="flex items-center">
              <PaintBrushIcon className="text-primary h-6 w-6 mr-2" />
              <span className="text-primary text-xl font-bold">Design System</span>
            </Link>
            <button
              className="text-muted-foreground hover:text-foreground -mr-1 p-2 rounded-md"
        ...
        <div className="bg-card relative z-10 flex h-16 flex-shrink-0 shadow">
          ...
          <div className="flex flex-1 justify-between px-4">
            <div className="flex flex-1">
              <div className="flex w-full md:ml-0">
                ...
                <div className="text-muted-foreground focus-within:text-primary relative w-full">
                  ...
                  <input
                    id="search-field"
                    className="text-foreground placeholder-muted-foreground focus:placeholder-muted-foreground block h-full w-full border-transparent bg-transparent py-2 pr-3 pl-10 focus:border-transparent focus:ring-0 focus:outline-none sm:text-sm"
            ...
            <div className="ml-4 flex items-center md:ml-6">
              <h1 className="text-xl font-semibold hidden sm:block">Design System Documentation</h1>
            </div>
          </div>
        </div>
