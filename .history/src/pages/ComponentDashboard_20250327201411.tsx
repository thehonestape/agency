      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center justify-between">
            <div>
              <Heading as="h1" size="3xl">Component Library</Heading>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="2xl">Form Patterns</Heading>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="2xl">List Patterns</Heading>
            <Button variant="outline" size="sm">
              View All Lists
            </Button>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="2xl">Dashboard Patterns</Heading>
            <Button variant="outline" size="sm">
              View All Dashboards
            </Button>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <Heading as="h2" size="2xl">UI Components</Heading>
            <Button variant="outline" size="sm">
              View All Components
            </Button>
          </div>
