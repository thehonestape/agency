            ...
            >
              ...
              >
                <div className="max-w-md space-y-2">
                  ...
                  <UI.Form.Select>
                    <UI.Form.SelectTrigger id="country">
                      <UI.Form.SelectValue placeholder="Select a country" />
                    </UI.Form.SelectTrigger>
                    <UI.Form.SelectContent>
                      <UI.Form.SelectItem value="us">United States</UI.Form.SelectItem>
                      <UI.Form.SelectItem value="ca">Canada</UI.Form.SelectItem>
                      <UI.Form.SelectItem value="mx">Mexico</UI.Form.SelectItem>
                      <UI.Form.SelectItem value="other">Other</UI.Form.SelectItem>
                    </UI.Form.SelectContent>
                  </UI.Form.Select>
                </div>
              </ComponentPreview>
