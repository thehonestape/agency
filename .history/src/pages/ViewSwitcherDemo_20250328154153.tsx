    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="grid gap-2">
          ...
          <input id="name" className="border p-2 rounded-md w-full" defaultValue="John Doe" />
        </div>
        
        <div className="grid gap-2">
          <Label htmlFor="email">Email Address</Label>
          <input id="email" className="border p-2 rounded-md w-full" defaultValue="john.doe@example.com" />
        </div>
