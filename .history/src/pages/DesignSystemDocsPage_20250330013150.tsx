...
const DesignSystemDocsPage: React.FC = () => {
  ...
  const sections = [
    ...
    { id: "dialog", title: "Dialog & Modals", icon: DocumentDuplicateIcon },
    { id: "toast", title: "Toasts & Alerts", icon: BellIcon },
    { id: "sheet", title: "Sheets & Drawers", icon: ViewColumnsIcon },
    { id: "dropdown", title: "Dropdown & Menu", icon: CommandLineIcon },
    { id: "select", title: "Select & Combobox", icon: CommandLineIcon },
    { id: "avatar", title: "Avatar & Media", icon: UserGroupIcon },
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="bg-background hover:bg-muted/50 transition-colors">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Alerts, toasts, and notifications</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-background hover:bg-muted/50 transition-colors">
            <CardContent className="p-6">
              <div className="flex items-center space-x-2 mb-2">
                <ArrowsPointingOutIcon className="h-5 w-5 text-primary" />
                <h3 className="font-medium">Layout</h3>
              </div>
              <p className="text-sm text-muted-foreground">Grids, containers, and spacing</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-background hover:bg-muted/50 transition-colors">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Menus, tabs, and pagination</p>
            </CardContent>
          </Card>
        </div>
        
        <h3 className="text-2xl font-bold mt-8 mb-6">Component Showcase</h3>
        <p className="mb-6">Our design system provides a wide range of components tailored for different use cases:</p>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-8">
          {[
            ...
            <li key={category} className="flex items-center gap-2 py-2 px-3 border rounded-md">
...
:root[data-theme="green"] {
  ...
  /* ... other variables */
      ...
      <Section
        id="dialog"
        title="Dialog & Modals"
        description="Dialog components for displaying modals, alerts, and confirmation prompts."
      >
        <ComponentPreview title="Dialog Example">
          <Dialog>
      ...
      <Section
        id="toast"
        title="Toasts & Alerts"
        description="Notification components for providing feedback to users."
      >
        <ComponentPreview title="Alert Examples">
          <div className="space-y-4">
            <Alert>
        ...
        <div className="mt-8">
          <h3 className="text-xl font-semibold mb-4">Toast Usage</h3>
          <p className="mb-4">
            Toasts can be triggered programmatically to show temporary notifications.
            The toast component provides a way to show brief, non-disruptive messages.
          </p>
          <Card className="mb-4">
            <CardHeader>
              <CardTitle>Toast Component</CardTitle>
              <CardDescription>Add to your UI with the toast provider</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-muted p-4 rounded-md">
                <code className="text-sm">
...
export function ToastDemo() {
  ...
  return (
    ...
    >
      ...
      {/* Sheet & Drawers Section */}
      <Section
        id="sheet"
        title="Sheets & Drawers"
        description="Side-panel components for additional content or actions."
      >
        <ComponentPreview title="Sheet Examples">
          <div className="flex flex-wrap gap-4">
            <Sheet>
      ...
      <Section
        id="dropdown"
        title="Dropdown & Menu"
        description="Components for displaying contextual menus and information in overlays."
      >
        <ComponentPreview title="Dropdown Menu">
          <div className="flex flex-wrap gap-6">
            <div className="relative inline-block">
              <Button variant="outline">Open Menu</Button>
              {/* Static menu example for demo purposes */}
              <div className="hidden absolute z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  <div className="block px-4 py-2 text-sm text-muted-foreground">Account</div>
                  <div className="border-t border-gray-100"></div>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-muted">Profile</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-muted">Billing</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-muted">Team</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-muted">Subscription</a>
                  <div className="border-t border-gray-100"></div>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-muted">Log out</a>
                </div>
              </div>
            </div>
            ...
            <div className="relative inline-block">
              ...
              {/* Static popover example for demo purposes */}
              <div className="hidden absolute z-10 mt-2 w-80 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 p-4 focus:outline-none">
                <div className="grid gap-4">
                  <div className="space-y-2">
            ...
            <div className="relative inline-block">
              <Button variant="outline" className="hover:bg-muted">Hover Me</Button>
              {/* Static tooltip example for demo purposes */}
              <div className="hidden absolute z-10 -mt-10 px-3 py-2 text-sm font-medium text-white rounded-md shadow-sm bg-black">
                This is a tooltip
              </div>
            </div>
          </div>
