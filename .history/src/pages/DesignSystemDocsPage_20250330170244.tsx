    ...
    <div className="space-y-12">
      ...
      >
        ...
        <div className="mb-12">
          ...
          <div className="bg-muted/20 p-6 rounded-lg border mb-8">
            <h4 className="text-lg font-medium mb-4">Typography Principles</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="text-sm text-muted-foreground mb-4">
                  Our typography system is built on these core principles:
                </p>
                <ul className="space-y-2 text-sm">
                  <li className="flex gap-2">
                    ...
                    <span><strong>Hierarchy:</strong> Clear visual distinction between levels of information</span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span><strong>Consistency:</strong> Predictable patterns across all interfaces</span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span><strong>Readability:</strong> Optimized for comfortable reading at any size</span>
                  </li>
                  <li className="flex gap-2">
                    <div className="h-5 w-5 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center text-primary text-xs">4</div>
                    <span><strong>Scale:</strong> Mathematical relationships between sizes</span>
                  </li>
                </ul>
              </div>
              
              <div className="bg-card p-4 rounded-md border">
                <h5 className="text-base font-medium mb-2">Scale Calculation</h5>
                <pre className="bg-muted p-3 rounded-md text-xs mb-2">
{`// Typography scale formula
base = 1rem (16px)
ratio = 1.2 (major third)

// Size progression
xs = base ÷ ratio = 0.833rem
sm = base = 1rem
md = base × ratio = 1.2rem
lg = base × ratio² = 1.44rem
xl = base × ratio³ = 1.728rem
2xl = base × ratio⁴ = 2.074rem
3xl = base × ratio⁵ = 2.488rem
4xl = base × ratio⁶ = 2.986rem`}
                </pre>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mb-8">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-xl">Font Weight System</CardTitle>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 border rounded-md">
                  <h4 className="text-base font-medium mb-3">Weight Pairing Principles</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      <div className="font-light text-xl mb-1">Primary Heading</div>
                      <div className="font-medium text-sm mb-1">Subheading with medium weight</div>
                      <p className="font-normal text-sm text-muted-foreground">
                        Body text uses regular weight for optimal readability in longer passages of content.
                      </p>
                    </div>
                    
                    <div>
                      <div className="font-bold text-xl mb-1">Strong Heading</div>
                      <div className="font-normal text-sm mb-1">Balanced subheading</div>
                      <p className="font-normal text-sm text-muted-foreground">
                        Creating contrast between heading and body text improves hierarchy and scannability.
                      </p>
                    </div>
                    
                    <div>
                      <div className="font-semibold text-xl mb-1">Section Header</div>
                      <div className="font-medium text-sm mb-1">Supporting text with emphasis</div>
                      <p className="font-light text-sm text-muted-foreground">
                        Light weight can provide elegant contrast in supporting information.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <h4 className="text-xl font-medium mb-4">Typography Scales</h4>
          <p className="text-base text-muted-foreground mb-6">
            Our system provides three complementary scales: Semantic (purpose-based), HTML (structured), and Content (editorial). Each serves different needs while maintaining consistent proportions.
          </p>
              ...
              <CardContent className="pt-4">
                <div className="space-y-4">
                  ...
                  <div className="border-b pb-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1 font-medium">Support text</p>
                  </div>
                  <div className="border-b pb-3">
                    <div className="text-lg font-medium">Subheadline M</div>
                    <p className="text-xs text-muted-foreground mt-1 font-medium">Secondary headers</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <Card>
              <CardHeader className="pb-2 border-b">
                <CardTitle className="text-xl">Italic & Monospace</CardTitle>
                <CardDescription>Special text treatments for specific contexts</CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <div className="grid grid-cols-1 gap-4">
                  <div className="border-b pb-3">
                    <div className="font-normal italic text-xl mb-1">Regular Italic</div>
                    <p className="text-xs text-muted-foreground font-medium">
                      For emphasis, quotes, and citations
                    </p>
                  </div>
                  <div className="border-b pb-3">
                    <div className="font-medium italic text-xl mb-1">Medium Italic</div>
                    <p className="text-xs text-muted-foreground font-medium">
                      For stronger emphasis within body text
                    </p>
                  </div>
                  <div className="border-b pb-3">
                    <div className="font-mono text-xl mb-1">Monospace Regular</div>
                    <p className="text-xs text-muted-foreground font-medium">
                      For code, technical data, and tabular content
                    </p>
                  </div>
                  <div className="border-b pb-3">
                    <div className="font-mono font-bold text-xl mb-1">Monospace Bold</div>
                    <p className="text-xs text-muted-foreground font-medium">
                      For emphasized code and technical terminology
                    </p>
                  </div>
                  <div className="border-b pb-3">
                    <div className="font-mono italic text-xl mb-1">Monospace Italic</div>
                    <p className="text-xs text-muted-foreground font-medium">
                      For specialized technical annotations
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader className="pb-2 border-b">
                <CardTitle className="text-xl">Practical Application</CardTitle>
                <CardDescription>Real-world typography combinations</CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <div className="space-y-6">
                  <div className="p-4 border rounded-md">
                    <div className="font-bold text-2xl mb-1">Article Heading</div>
                    <div className="font-medium text-base mb-3">Supporting subheading provides additional context</div>
                    <p className="font-normal text-sm mb-2">
                      The main body text uses a comfortable reading size with sufficient line height. 
                      Good typography maintains <span className="italic">consistent rhythm</span> and creates
                      clear hierarchy between elements.
                    </p>
                    <div className="font-medium text-sm mt-3">Key Takeaway</div>
                    <p className="font-normal text-xs text-muted-foreground">
                      Smaller text works well for supplementary information and metadata.
                    </p>
                  </div>
                  
                  <div className="p-4 border rounded-md bg-muted/5">
                    <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Documentation</div>
                    <div className="font-semibold text-xl mb-2">Technical Guide</div>
                    <p className="font-normal text-sm mb-3">
                      Technical documentation combines regular body text with 
                      specialized formatting for code and commands.
                    </p>
                    <div className="font-mono text-sm bg-muted p-2 rounded mb-2">
                      npm install @maison/typography
                    </div>
                    <p className="font-normal text-xs text-muted-foreground">
                      Use monospace for all code examples and terminal commands.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="bg-muted/20 p-6 rounded-lg border">
            <h4 className="text-xl font-semibold mb-4">Typography Implementation</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h5 className="text-base font-medium mb-3">Utility Classes</h5>
                <div className="bg-card p-4 rounded-md border">
...
/* Font Families */
.font-sans      { font-family: var(--font-maison-neue); }
.font-mono      { font-family: var(--font-maison-neue-mono); }
...
.text-3xl       { font-size:.875rem;  line-height: 1.2; }
.text-4xl       { font-size: 2.25rem;  line-height: 1.1; }`}
              ...
              <div>
                <h5 className="text-base font-medium mb-3">Component Example</h5>
                <div className="bg-card p-4 rounded-md border">
                  <pre className="text-xs overflow-auto">
