...
const SideNav: React.FC<SideNavProps> = ({ sections, activeSection, onClick }) => {
  return (
    <div className="fixed top-0 left-0 w-64 h-full bg-background border-r border-border z-20">
      {/* Sidebar Header */}
      ...
      {/* Navigation Links */}
      <div className="py-6 px-4 h-[calc(100vh-64px)] overflow-auto">
        <div className="mb-4">
          <ThemeSwitcher />
        </div>
...
const DesignSystemDocsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="ml-64">
        {/* Title Bar */}
        <div className="h-16 border-b border-border fixed top-0 left-64 right-0 bg-background z-10">
          <div className="h-full flex items-center px-8">
            <h1 className="text-xl font-bold">Design System Documentation</h1>
          </div>
        </div>
        
        {/* Content Area */}
        <div className="pt-20 px-8 pb-20 max-w-5xl mx-auto">
          {/* Introduction */}
          <Section 
            id="intro" 
            title="Introduction" 
