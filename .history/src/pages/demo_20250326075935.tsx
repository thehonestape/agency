...
const sections = [
  { name: 'Foundation', href: '#foundation', items: foundationNav, current: false },
  { name: 'Components', href: '#components', items: componentNav, current: false },
  { name: 'Patterns', href: '#patterns', items: patternNav, current: false },
]
