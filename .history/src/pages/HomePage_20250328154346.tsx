    ...
    <main className="py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Standalone App Prototype</CardTitle>
              <CardDescription>
                Complete app without complex routing
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                A full application prototype that demonstrates how to build a complete
                user interface with state-based view switching instead of React Router.
              </p>
            </CardContent>
            <CardFooter>
              <Button asChild variant="outline" className="w-full">
                <Link to="/standalone-demo">Open App</Link>
              </Button>
            </CardFooter>
          </Card>
        </div>
