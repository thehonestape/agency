      ...
      >
          ...
          <div className="md:col-span-4">
            <Card className="h-full">
              ...
              <CardContent>
                <div className="prose dark:prose-invert">
                  <p>
                    Our typography system starts with three foundational font families that can be combined to tell your brand story across all channels:
                  </p>
                  
                  <div className="mt-6 space-y-6">
                    <div className="rounded-lg overflow-hidden border">
                      <div className="p-4 bg-primary/10">
                        <h3 className="text-xl font-serif mb-1">Serif</h3>
                        <p className="text-sm font-serif">
                          <span className="text-base font-medium">Georgia, Times New Roman, serif</span><br/>
                          <span className="text-muted-foreground">Conveys tradition, reliability and formality. Perfect for editorial and long-form content.</span>
                        </p>
                      </div>
                      <div className="p-4 border-t">
                        <p className="font-serif">
                          <span className="text-xl font-medium">Primary headlines that demand authority</span><br/>
                          <span className="text-lg">Strong subheadings for editorial contexts</span><br/>
                          <span className="text-base">Body copy for long-form reading experiences where tradition matters</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden border">
                      <div className="p-4 bg-primary/10">
                        <h3 className="text-xl font-sans mb-1">Sans Serif</h3>
                        <p className="text-sm font-sans">
                          <span className="text-base font-medium">Inter, Helvetica, system-ui</span><br/>
                          <span className="text-muted-foreground">Modern, clean and functional. Versatile for interfaces, products, and marketing materials.</span>
                        </p>
                      </div>
                      <div className="p-4 border-t">
                        <p className="font-sans">
                          <span className="text-xl font-medium">Clean product headlines and marketing</span><br/>
                          <span className="text-lg">Interface elements and navigation systems</span><br/>
                          <span className="text-base">Primary UI text where readability is critical</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden border">
                      <div className="p-4 bg-primary/10">
                        <h3 className="text-xl font-mono mb-1">Monospace</h3>
                        <p className="text-sm font-mono">
                          <span className="text-base font-medium">Consolas, Monaco, monospace</span><br/>
                          <span className="text-muted-foreground">Technical precision and code representation. Creates a distinct technical voice.</span>
                        </p>
                      </div>
                      <div className="p-4 border-t">
                        <p className="font-mono">
                          <span className="text-xl font-medium">Technical documentation headers</span><br/>
                          <span className="text-lg">Code samples and technical specifications</span><br/>
                          <span className="text-base">Data-focused UI elements and terminals</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  
                  <h3 className="text-lg font-medium mt-8 mb-3">Font Pairing Across Channels</h3>
                  ...
                  <div className="mt-4 rounded-lg border overflow-hidden">
                    <div className="p-4 border-b bg-primary/5">
                      <div className="flex justify-between items-center">
                        <h4 className="text-lg font-medium">Brand Story Combinations</h4>
                        <Button 
                          size="sm" 
                          variant="outline" 
                          className="h-8 gap-1"
                          onClick={shuffleFontCombinations}
                        >
                          <span>Shuffle</span>
                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5">
                            <path d="M12.5 1C12.2239 1 12 1.22386 12 1.5C12 1.77614 12.2239 2 12.5 2H13.2929L9 6.29289L6.5 3.79289L0.646447 9.64645L1.35355 10.3536L6.5 5.20711L9 7.70711L13.2929 3.41421V4C13.2929 4.27614 13.5168 4.5 13.7929 4.5C14.0691 4.5 14.2929 4.27614 14.2929 4V1.5C14.2929 1.22386 14.0691 1 13.7929 1H12.5ZM1.35355 4.64645L0.646447 5.35355L3.5 8.20711L4.20711 7.5L1.35355 4.64645ZM5.79289 6.5L5.08579 7.20711L6.5 8.62132L7.20711 7.91421L5.79289 6.5Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd" />
                          </svg>
                        </Button>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                        ...
                        {fontCombination === 1 && (
                          <div className="space-y-1">
                            <div className="text-3xl font-serif tracking-tight">Traditional & Established</div>
                            <div className="text-lg font-sans">Serif headlines with sans-serif body text communicates heritage with modern functionality.</div>
                            <div className="flex flex-wrap gap-2 mt-2">
                              {channels.filter(c => c.active).map((channel) => (
                                <Badge variant="outline" key={channel.id} className="bg-background">
                                  {channel.name}
                                </Badge>
                              ))}
                              {channels.filter(c => c.active).length === 0 && (
                                <div className="text-sm text-muted-foreground italic">Select channels above to see where this combination works best</div>
                              )}
                            </div>
                          </div>
                        )}
                        ...
                        {fontCombination === 2 && (
                          <div className="space-y-1">
                            <div className="text-3xl font-sans font-bold tracking-tight">Modern & Technical</div>
                            <div className="text-lg font-mono">Sans-serif headlines with monospace details creates a contemporary technical aesthetic.</div>
                            <div className="flex flex-wrap gap-2 mt-2">
                              {channels.filter(c => c.active).map((channel) => (
                                <Badge variant="outline" key={channel.id} className="bg-background">
                                  {channel.name}
                        ...
                        {fontCombination === 3 && (
                          <div className="space-y-1">
                            <div className="text-3xl font-mono tracking-tight">Innovative & Bold</div>
                            <div className="text-lg font-serif">Monospace headlines with serif body text creates unexpected juxtaposition that stands out.</div>
                            <div className="flex flex-wrap gap-2 mt-2">
                              {channels.filter(c => c.active).map((channel) => (
                                <Badge variant="outline" key={channel.id} className="bg-background">
                                  {channel.name}
                  ...
                  <div className="text-sm text-muted-foreground mt-4">
                    <p>These font combinations can be used across all channels to maintain brand consistency while adapting to the specific needs of each medium. The key is to establish clear roles for each typeface in your communication hierarchy.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>Core typographic building blocks for your brand identity</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="rounded-lg overflow-hidden border">
                  <div className="p-6 bg-primary/10">
                    <h3 className="text-2xl font-serif mb-2">Serif</h3>
                    <p className="text-base font-serif">
                      <span className="text-lg font-medium">Georgia, Times New Roman, serif</span><br/>
                      <span className="text-muted-foreground mt-2 block">Conveys tradition, reliability and formality. Perfect for editorial and long-form content.</span>
                    </p>
                  </div>
                  <div className="p-6 border-t">
                    <p className="font-serif space-y-3">
                      <span className="text-2xl font-medium block">Primary headlines that demand authority</span>
                      <span className="text-xl block">Strong subheadings for editorial contexts</span>
                      <span className="text-base block">Body copy for long-form reading experiences where tradition matters</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg overflow-hidden border">
                  <div className="p-6 bg-primary/10">
                    <h3 className="text-2xl font-sans mb-2">Sans Serif</h3>
                    <p className="text-base font-sans">
                      <span className="text-lg font-medium">Inter, Helvetica, system-ui</span><br/>
                      <span className="text-muted-foreground mt-2 block">Modern, clean and functional. Versatile for interfaces, products, and marketing materials.</span>
                    </p>
                  </div>
                  <div className="p-6 border-t">
                    <p className="font-sans space-y-3">
                      <span className="text-2xl font-medium block">Clean product headlines and marketing</span>
                      <span className="text-xl block">Interface elements and navigation systems</span>
                      <span className="text-base block">Primary UI text where readability is critical</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg overflow-hidden border">
                  <div className="p-6 bg-primary/10">
                    <h3 className="text-2xl font-mono mb-2">Monospace</h3>
                    <p className="text-base font-mono">
                      <span className="text-lg font-medium">Consolas, Monaco, monospace</span><br/>
                      <span className="text-muted-foreground mt-2 block">Technical precision and code representation. Creates a distinct technical voice.</span>
                    </p>
                  </div>
                  <div className="p-6 border-t">
                    <p className="font-mono space-y-3">
                      <span className="text-2xl font-medium block">Technical documentation headers</span>
                      <span className="text-xl block">Code samples and technical specifications</span>
                      <span className="text-base block">Data-focused UI elements and terminals</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                <h3 className="text-xl font-medium mb-4">Font Pairing Across Channels</h3>
                <p className="mb-6">
                  Drag and select channels below to see how our font combinations can be applied consistently across different media:
                </p>
                ...
                <div className="rounded-lg border overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="space-y-8">
                      ...
                      {fontCombination === 1 && (
                        <div>
                          <div className="text-4xl font-serif tracking-tight mb-2">Traditional & Established</div>
                          <div className="text-xl font-sans mb-4">Serif headlines with sans-serif body text communicates heritage with modern functionality.</div>
                          <div className="flex flex-wrap gap-2 mt-2">
                            {channels.filter(c => c.active).length > 0 ? (
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                                {channels.filter(c => c.active).map((channel) => (
                                  <div key={channel.id} className="bg-muted/20 p-4 rounded-lg border">
                                    <div className="font-medium mb-2">{channel.name}</div>
                                    <div className="font-serif text-xl mb-1">Primary Heading</div>
                                    <div className="font-sans text-base">Body text and interface elements maintain a clean, accessible presentation while primary headlines use serif to convey authority.</div>
                                  </div>
                                ))}
                              </div>
                            ) : (
                              <div className="text-muted-foreground italic p-4 bg-muted/10 rounded-lg w-full text-center">
                                Select channels above to see where this combination works best
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      {fontCombination === 2 && (
                        <div>
                          <div className="text-4xl font-sans font-bold tracking-tight mb-2">Modern & Technical</div>
                          <div className="text-xl font-mono mb-4">Sans-serif headlines with monospace details creates a contemporary technical aesthetic.</div>
                          <div className="flex flex-wrap gap-2 mt-2">
                            {channels.filter(c => c.active).length > 0 ? (
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                                {channels.filter(c => c.active).map((channel) => (
                                  <div key={channel.id} className="bg-muted/20 p-4 rounded-lg border">
                                    <div className="font-medium mb-2">{channel.name}</div>
                                    <div className="font-sans text-xl mb-1">Primary Heading</div>
                                    <div className="font-mono text-base">Technical specifications and data presented with precision, while bold sans-serif headlines provide clear navigation.</div>
                                  </div>
                                ))}
                              </div>
                            ) : (
                      ...
                      {fontCombination === 3 && (
                        <div>
                          <div className="text-4xl font-mono tracking-tight mb-2">Innovative & Bold</div>
                          <div className="text-xl font-serif mb-4">Monospace headlines with serif body text creates unexpected juxtaposition that stands out.</div>
                          <div className="flex flex-wrap gap-2 mt-2">
                            {channels.filter(c => c.active).length > 0 ? (
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                                {channels.filter(c => c.active).map((channel) => (
                                  <div key={channel.id} className="bg-muted/20 p-4 rounded-lg border">
                                    <div className="font-medium mb-2">{channel.name}</div>
                                    <div className="font-mono text-xl mb-1">Primary Heading</div>
                                    <div className="font-serif text-base">This surprising combination creates memorable contrast between technical headers and elegant body text, ideal for creative projects.</div>
                                  </div>
                                ))}
                              </div>
                            ) : (
        ...
        {/* Type Scales - Full Width Section */}
