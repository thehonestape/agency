...
const DesignSystemDocsPage: React.FC = () => {
  ...
  // Example colors
  const themeColors = [
    { name: "Background", bg: "bg-background", value: "var(--background)" },
    { name: "Foreground", bg: "bg-foreground", value: "var(--foreground)" },
  ...
  const uiColors = [
    { name: "Card", bg: "bg-card", value: "var(--card)" },
    { name: "Muted", bg: "bg-muted", value: "var(--muted)" },
    { name: "Destructive", bg: "bg-destructive", value: "var(--destructive)" },
    { name: "Border", bg: "bg-border", value: "var(--border)" },
    { name: "Ring", bg: "bg-ring", value: "var(--ring)" },
  ];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="py-8 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-muted-foreground">Comprehensive documentation of our design patterns and components</p>
        </div>
      </div>
        ...
        <div className="lg:flex lg:gap-10">
          ...
          <div className="lg:flex-1">
            ...
            >
              ...
              >
                <div className="max-w-md space-y-2">
                  <label className="block text-sm font-medium" id="country-label">Country</label>
                  <select
                ...
                <div className="space-y-4">
                  <div className="bg-green-500/10 border-l-4 border-green-500 p-4 rounded">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-green-800 text-sm font-medium">Successfully saved changes</p>
                      </div>
                    </div>
                  </div>
