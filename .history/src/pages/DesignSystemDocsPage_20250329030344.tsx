    ...
    <div className="bg-background text-foreground min-h-screen flex flex-col">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          <div className="fixed inset-0 bg-foreground/80" onClick={() => setMobileMenuOpen(false)} />
          <div className="fixed inset-y-0 left-0 flex w-full max-w-xs flex-col overflow-y-auto bg-background shadow-lg">
