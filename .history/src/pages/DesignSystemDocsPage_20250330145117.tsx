  ...
  --font-maison-neue-mono: 'Maison Neue Mono', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;
              ...
              <Alert className="mt-4" variant="info">
                ...
                <AlertDescription className="mt-2 text-sm">
                  Maison Neue is a commercial font. This documentation shows the typography using fallback system fonts until the actual Maison Neue font files are added to <code className="text-xs bg-muted/60 px-1 py-0.5 rounded">/public/fonts/</code> directory. The CSS is already configured to use the proper files when they become available.
                </AlertDescription>
              </Alert>
            </div>
          </CardContent>
