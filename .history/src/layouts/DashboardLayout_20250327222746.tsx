...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Button', href: '/dashboard/design/button', icon: 'square' },
      { label: 'Card', href: '/dashboard/design/card', icon: 'layout' },
      { label: 'Input', href: '/dashboard/design/input', icon: 'form' },
      { label: 'Spacing', href: '/dashboard/design/spacing', icon: 'ruler' },
      { label: 'Icons', href: '/dashboard/design/icons', icon: 'image' }
    ]
  },
  {
    label: 'Resources',
