    ...
    <li>
      {item.href ? (
        ...
        <button
          ...
          className={cn(
            'w-full text-left text-muted-foreground hover:text-accent-foreground hover:bg-accent',
        ...
        >
          <div className="flex items-center gap-x-3">
            {item.icon && (
              <item.icon
                className="h-6 w-6 shrink-0 text-muted-foreground group-hover:text-accent-foreground"
                aria-hidden="true"
              />
            )}
            {item.name}
          ...
          <div className="flex flex-1 justify-between px-4">
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <Menu as="div" className="relative ml-3">
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-card py-2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      <Menu.Item key={item.name}>
                        {({ active }) => (
                          <Link
                            ...
                            className={cn(
                              active ? 'bg-accent' : '',
                              'block px-3 py-1 text-sm text-foreground'
                            )}
                          >
                            {item.name}
                          </Link>
