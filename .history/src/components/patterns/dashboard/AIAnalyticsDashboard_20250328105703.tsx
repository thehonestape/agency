                ...
                <Card decoration="top" decorationColor="purple">
                  <Flex alignItems="center">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-violet-100 dark:bg-violet-900/20">
                      <FiCpu className="h-6 w-6 text-violet-500" />
                    </div>
                    <div className="ml-3">
              ...
              <Card className="mt-6">
                ...
                <div className="mt-6 rounded-lg border p-4">
                  <Flex justifyContent="between" alignItems="center">
                    ...
                    <div>
                      <Text className="text-emerald-500">Savings Opportunity</Text>
                      <Metric className="text-emerald-500">$0.85</Metric>
                    </div>
                  </Flex>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 space-y-4">
                    <div className="rounded-r-lg border-l-4 border-emerald-500 bg-emerald-50 dark:bg-emerald-950/20 p-3">
                    ...
                    <div className="rounded-r-lg border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-950/20 p-3">
                    ...
                    <div className="rounded-r-lg border-l-4 border-violet-500 bg-violet-50 dark:bg-violet-950/20 p-3">
