              ...
              <Card className="mt-6">
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 space-y-4">
                    <div className="rounded-r-lg border-l-4 border-green-500 bg-green-50 p-3">
                    ...
                    <div className="rounded-r-lg border-l-4 border-blue-500 bg-blue-50 p-3">
                    ...
                    <div className="rounded-r-lg border-l-4 border-purple-500 bg-purple-50 p-3">
