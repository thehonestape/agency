...
interface FullWidthThreeColumnProps {
    ...
    <div>
      ...
      <div className="xl:pl-72">
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-white/5 bg-gray-900 px-4 shadow-sm sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-200">
        ...
        <div className="flex min-h-screen">
          ...
          <aside className="hidden lg:order-first lg:block lg:flex-1 lg:border-r lg:border-white/5">
            <div className="flex h-full flex-col overflow-y-auto">
              {renderSidebarContent ? (
                renderSidebarContent()
              ) : (
                <div className="p-6">
                  <h2 className="text-lg font-semibold text-white">Secondary Column</h2>
                  <p className="mt-2 text-sm text-gray-400">This is the secondary column, typically used for navigation or filters.</p>
                </div>
              )}
            </div>
          </aside>
            ...
            <div className="flex-1 overflow-y-auto">
              {renderMiddleContent ? (
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-sm text-gray-400">This is the main content area, typically used for the primary interface.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <aside className="hidden xl:block xl:flex-1">
            <div className="flex h-full flex-col overflow-y-auto">
              {renderRightContent ? (
                ...
                <div className="p-6">
                  <h2 className="text-lg font-semibold text-white">Right Column</h2>
                  <p className="mt-2 text-sm text-gray-400">This is the right column, typically used for details or additional information.</p>
                </div>
              )}
            </div>
          </aside>
