...
type BlockNoteEditorType = any;
type PartialBlockType = any;
type UseBlockNoteType = (config: any) => any;
type BlockNoteViewType = React.ComponentType<any>;
type UseThemeType = () => { theme?: string; setTheme?: (theme: string) => void };

// Try to import BlockNote dependencies, but don't fail if they're not available
let BlockNoteEditorType: BlockNoteEditorType;
let PartialBlock: PartialBlockType;
let useBlockNote: UseBlockNoteType;
let BlockNoteView: BlockNoteViewType;
