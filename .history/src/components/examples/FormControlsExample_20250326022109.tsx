    ...
    <div className="space-y-8">
      {showBanner && (
        <Banner 
          ...
          className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg shadow-sm"
        >
          <div className="flex items-center gap-3">
            <BellIcon className="h-5 w-5 text-blue-600 dark:text-blue-400" />
            <div>
              <BannerTitle className="text-blue-800 dark:text-blue-300">UI Components Library</BannerTitle>
              <BannerDescription className="text-blue-700/80 dark:text-blue-400/80">Browse form controls and interactive elements below</BannerDescription>
            </div>
          </div>
        </Banner>
      )}
      ...
      <Card className="border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        <div className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 px-6 py-4">
          <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Checkbox Examples</h2>
        </div>
        ...
        <CardContent className="p-6">
          <div className="space-y-8">
            {/* Basic Checkbox */}
            <div>
              <h3 className="text-sm font-medium mb-3 text-gray-900 dark:text-gray-200">Basic Checkbox</h3>
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  <Checkbox id="checkbox-basic" />
                  <label htmlFor="checkbox-basic" className="text-sm text-gray-700 dark:text-gray-300">Default</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="checkbox-checked" defaultChecked />
                  <label htmlFor="checkbox-checked" className="text-sm text-gray-700 dark:text-gray-300">Checked</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="checkbox-disabled" disabled />
                  <label htmlFor="checkbox-disabled" className="text-sm text-gray-500 dark:text-gray-500">Disabled</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="checkbox-disabled-checked" disabled defaultChecked />
                  <label htmlFor="checkbox-disabled-checked" className="text-sm text-gray-500 dark:text-gray-500">Disabled checked</label>
                </div>
              </div>
            </div>
            ...
            {/* Checkbox with Label */}
            <div>
              <h3 className="text-sm font-medium mb-3 text-gray-900 dark:text-gray-200">Checkbox with Label</h3>
            ...
            <div>
              <h3 className="text-sm font-medium mb-3 text-gray-900 dark:text-gray-200">Notification Preferences</h3>
              <fieldset className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50/50 dark:bg-gray-900/50">
                <legend className="text-xs font-medium text-gray-500 dark:text-gray-400 px-2">Email settings</legend>
