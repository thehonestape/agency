...
export function ShowcaseLayout({ 
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div
        className={cn(
          "fixed md:relative z-50 md:z-auto transition-all duration-300 ease-in-out h-full bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800",
      ...
      >
        {/* Mobile Header */}
        <header className="md:hidden flex items-center h-14 px-4 border-b border-gray-200 dark:border-gray-800">
          <button
            onClick={toggleMobileSidebar}
            className="p-1.5 mr-2 rounded-md text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800"
