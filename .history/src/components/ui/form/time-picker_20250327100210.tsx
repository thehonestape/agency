  ...
  ({ 
    ...
    return (
      <div className="space-y-2">
        ...
        <div className={cn(timePickerVariants({ 
          size, 
          state, 
          variant, 
          border, 
          ...
          {showIcon && (
            <Clock className={cn(timeIconVariants({ size }))} />
          )}
          <input
            ref={ref}
            type="time"
...
export { TimePicker, timePickerVariants, timeInputVariants, timeIconVariants }; 