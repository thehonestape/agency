...
const headingVariants = cva(
  "tracking-tight select-none font-[var(--font-maison-neue)]",
  {
    variants: {
      variant: {
        h1: "text-4xl text-fluid-4xl leading-tight font-bold text-default",
        h2: "text-3xl text-fluid-3xl leading-snug font-semibold text-default",
        h3: "text-2xl text-fluid-2xl leading-snug font-semibold text-default",
        h4: "text-xl text-fluid-xl leading-normal font-medium text-default",
        h5: "text-lg text-fluid-lg leading-normal font-medium text-default",
        h6: "text-base text-fluid-base leading-normal font-medium text-default",
      },
      size: {
