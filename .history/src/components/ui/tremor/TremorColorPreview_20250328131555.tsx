...
import { themeToTremorColors, defaultTremorColors, TremorColorValue } from './theme-config';
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            {Object.entries(themeToTremorColors).map(([themeColor, tremorColor]) => (
              <Badge key={themeColor} color={tremorColor}>
                {themeColor}
              </Badge>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <DonutChart
              ...
              index="name"
              category="value"
              colors={Object.values(themeToTremorColors).slice(0, 5) as TremorColorValue[]}
              className="h-56 mt-4"
            />
            <Legend
              className="mt-3"
          ...
          <div>
            ...
            <DonutChart
              ...
              index="name"
              category="value"
              colors={defaultTremorColors.chart as TremorColorValue[]}
              className="h-56 mt-4"
            />
            <Legend
              className="mt-3"
