...
import { type SidebarShellProps, type NavigationItem } from '../types'
import { composeSidebarShellStyles } from '../compose'

const navigation: NavigationItem[] = [
  { id: 'dashboard', label: 'Dashboard', href: '#', icon: <HomeIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: true },
  { id: 'team', label: 'Team', href: '#', icon: <UsersIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
  { id: 'projects', label: 'Projects', href: '#', icon: <FolderIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
  { id: 'calendar', label: 'Calendar', href: '#', icon: <CalendarIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
  { id: 'documents', label: 'Documents', href: '#', icon: <DocumentDuplicateIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
  { id: 'reports', label: 'Reports', href: '#', icon: <ChartPieIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
  { id: 'settings', label: 'Settings', href: '#', icon: <Cog6ToothIcon className="h-6 w-6 shrink-0" aria-hidden="true" />, active: false },
]
                ...
                >
                  <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                    <button type="button" className="-m-2.5 p-2.5" onClick={() => setSidebarOpen(false)}>
                      ...
                      <XMarkIcon className="h-6 w-6 text-muted-foreground" aria-hidden="true" />
                    </button>
                  </div>
                </Transition.Child>
                  ...
                  <nav className="flex flex-1 flex-col">
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <li className="-mx-6 mt-auto">
                        <a
                          href="#"
                          className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-foreground hover:bg-muted"
                        >
                          <img
