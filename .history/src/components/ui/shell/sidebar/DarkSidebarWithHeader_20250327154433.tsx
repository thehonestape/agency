...
const navigation = [
  { id: 'dashboard', label: 'Dashboard', name: 'Dashboard', href: '#', icon: HomeIcon, current: true },
  { id: 'team', label: 'Team', name: 'Team', href: '#', icon: UsersIcon, current: false },
  { id: 'projects', label: 'Projects', name: 'Projects', href: '#', icon: FolderIcon, current: false },
  { id: 'calendar', label: 'Calendar', name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
  { id: 'documents', label: 'Documents', name: 'Documents', href: '#', icon: DocumentDuplicateIcon, current: false },
  { id: 'reports', label: 'Reports', name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
  { id: 'settings', label: 'Settings', name: 'Settings', href: '#', icon: Cog6ToothIcon, current: false },
]

const userNavigation = [
  { id: 'profile', label: 'Your profile', name: 'Your profile', href: '#' },
  { id: 'signout', label: 'Sign out', name: 'Sign out', href: '#' },
]
