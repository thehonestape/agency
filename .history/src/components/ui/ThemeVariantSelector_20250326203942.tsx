  ...
  return (
    <div className={cn("relative", className)} {...props}>
      ...
      >
        <SelectTrigger 
          className={cn(
            "h-9 min-w-[200px] rounded-md px-3",
        ...
        <SelectContent 
          className="min-w-[220px] p-1 bg-popover border border-border rounded-md shadow-md text-popover-foreground overflow-hidden animate-in fade-in-80 data-[side=bottom]:slide-in-from-top-1 data-[side=top]:slide-in-from-bottom-1"
          position="popper"
          sideOffset={4}
        >
          {availableThemes.map((theme) => (
            <SelectItem 
              ...
              className="flex items-center gap-4 py-3 px-4 cursor-pointer rounded-sm text-sm hover:bg-accent/50 focus:bg-accent focus:text-accent-foreground data-[highlighted]:bg-accent"
            >
              <div 
