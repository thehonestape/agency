    ...
    compoundVariants: [
      {
        ...
        className:
          'before:absolute before:inset-0 before:bg-white before:opacity-0 before:transition-opacity hover:before:opacity-5 active:before:opacity-10 focus-visible:before:opacity-10',
      },
    ],
  }
);
