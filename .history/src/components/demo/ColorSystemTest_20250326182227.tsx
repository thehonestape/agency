  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="h-20 rounded-md overflow-hidden border border-border" style={{ backgroundColor: 'hsl(var(--primary))' }}>
            <div className="p-2">
              <span className="font-medium text-white">primary (raw CSS)</span>
            </div>
          </div>
          <div className="h-20 rounded-md overflow-hidden border border-border" style={{ backgroundColor: 'hsl(var(--primary) / 0.5)' }}>
            <div className="p-2">
              <span className="font-medium">primary/50% (raw CSS)</span>
            </div>
          </div>
          <div className="h-20 rounded-md overflow-hidden border border-border" style={{ backgroundColor: 'hsl(var(--destructive))' }}>
            <div className="p-2">
              <span className="font-medium text-white">destructive (raw CSS)</span>
            </div>
          </div>
          <div className="h-20 rounded-md overflow-hidden border border-border" style={{ backgroundColor: 'hsl(var(--accent))' }}>
            <div className="p-2">
              <span className="font-medium">accent (raw CSS)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Debug section to show the actual HSL values */}
      <section className="space-y-4 mt-10 p-4 border rounded-md">
        ...
        <div className="grid grid-cols-1 gap-2 font-mono text-sm">
          <div>--primary: var(--primary)</div>
          <div>--secondary: var(--secondary)</div>
          <div>--accent: var(--accent)</div>
          <div>--destructive: var(--destructive)</div>
